    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{marginTop : hp("3%")}} >
          ...
          <Image style={{marginLeft : wp("30%")}} resizeMode="contain" source={require("../images/reset.png")}  />
        </View>

        <View style={{ flex: 1, justifyContent: "center", marginLeft: 20, marginRight: 20, marginTop: -20 }} >

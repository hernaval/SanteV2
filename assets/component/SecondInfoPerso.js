...
import { size, weight } from '../Helpers/profileConst';
 ...
 class SecondInfoPerso extends Component {
    constructor(props){
        super(props);
        this.state = {
          samaritain: false,
        ...
        return (
            <View style={styles.container}>
              <View style={styles.under}>
                <HeaderProfile dest="Profile" navigation={this.props.navigation}/>
              </View>
              ...
              <ScrollView style={[styles.scroll,{marginTop : 10}]} >
                    <View style={styles.userRow}>
                        ...
                        <View style={styles.userImage}>
                            <Avatar rounded
                                onPress={()=>{this.props.navigation.navigate("SecondProfil")}}
                                size="large"
                    ...
                    <View>
                        ...
                        <ListItem
                            ...
                            rightTitle ={this.props.second.second_users[this.props.second.indexSelected].firstName}
                        ...
                        <ListItem
                            ...
                            title="Nom"
                            titleStyle={{fontWeight : "bold"}}
                            rightTitle ={this.props.second.second_users[this.props.second.indexSelected].lastName}
                            containerStyle={styles.listItemContainer}
                        />
                        <ListItem
                            hideChevron
                            ...
                            title="Adresse"
                            titleStyle={{fontWeight : "bold"}}
                            rightTitle ={this.props.second.second_users[this.props.second.indexSelected].address}
                            containerStyle={styles.listItemContainer}
                        />
                        <ListItem
                            hideChevron
                            title="Code postal"
                            titleStyle={{fontWeight : "bold"}}
                            rightTitle ={this.props.second.second_users[this.props.second.indexSelected].zip}
                            containerStyle={styles.listItemContainer}
                        />
                        <ListItem
                            hideChevron
                            title="Ville"
                            titleStyle={{fontWeight : "bold"}}
                            rigthTitle ={this.props.second.second_users[this.props.second.indexSelected].city}
                            containerStyle={styles.listItemContainer}
                        />
                        <ListItem
                            hideChevron
...
const styles = StyleSheet.create({
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(SecondInfoPerso);
